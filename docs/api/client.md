...
```python
def get_digital_twin(digital_twin_id: str, **kwargs: Any) -> Dict[str, Any]
```
...
```python
def upsert_digital_twin(digital_twin_id: str, digital_twin: Dict[str, Any],
...
```python
def update_digital_twin(digital_twin_id: str, json_patch: List[Dict[str, Any]],
                        **kwargs: Any) -> None
```
...
```python
def delete_digital_twin(digital_twin_id: str, **kwargs: Any) -> None
```
...
```python
def get_component(digital_twin_id: str, component_name: str,
                  **kwargs: Any) -> Dict[str, Any]
```
...
```python
def update_component(digital_twin_id: str, component_name: str,
                     json_patch: List[Dict[str, Any]], **kwargs: Any) -> None
```
...
```python
def get_relationship(digital_twin_id: str, relationship_id: str,
                     **kwargs: Any) -> Dict[str, Any]
```
...
```python
def upsert_relationship(digital_twin_id: str, relationship_id: str,
...
```python
def update_relationship(digital_twin_id: str, relationship_id: str,
...
```python
def delete_relationship(digital_twin_id: str, relationship_id: str,
                        **kwargs: Any) -> None
```
...
```python
def create_models(dtdl_models: List[Dict[str, Any]],
...
```python
def decommission_model(model_id: str, **kwargs: Any) -> None
```
...
```python
def delete_model(model_id: str, **kwargs: Any) -> None
```
...
```python
def publish_telemetry(digital_twin_id: str,
...
```python
def publish_component_telemetry(digital_twin_id: str,
                                component_name: str,
                                telemetry: Dict[str, Any],
                                message_id: Optional[str] = None,
                                **kwargs: Any) -> None
...
```python
def list_import_jobs(**kwargs: Any) -> PagedIterator
```
...
```python
def get_import_job(job_id: str, **kwargs: Any) -> ImportJob
```
...
```python
def create_import_job(job_id: str, import_job: Dict[str, Any],
...
```python
def delete_import_job(job_id: str, **kwargs: Any) -> None
```
...
```python
def cancel_import_job(job_id: str, **kwargs: Any) -> ImportJob
```
...
```python
def list_delete_jobs(**kwargs: Any) -> PagedIterator
```
...
```python
def get_delete_job(job_id: str, **kwargs: Any) -> DeleteJob
```
...
```python
def create_delete_job(job_id: str,

...
class KonnektrGraphClient:
    ...
    async def delete_all_models(self, **kwargs: Any) -> None:
        """
    ...
    async def search_memory(
        ...
        **kwargs: Any,
        ...
        data = await self._request("POST", url, json=body, **kwargs)
        return [MemorySearchResult.from_dict(item) for item in data]

    async def ensure_memory_search_index(
        self,
        dimension: int,
        embedding_property: str = "embedding",
        m: Optional[int] = None,
        ...
        **kwargs: Any,
        ...
        data = await self._request("POST", url, json=body, **kwargs)
        return MemorySearchIndex.from_dict(data)

    async def get_memory_search_capability(
        self, **kwargs: Any
    ) -> MemorySearchCapability:
        """
        ...
        data = await self._request("GET", url, **kwargs)
        return MemorySearchCapability.from_dict(data)
